  ...
  return (
    <main className="flex flex-col gap-8 justify-start items-center h-auto px-4 sm:px-8 md:px-16 lg:px-32 xl:px-64">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row justify-center items-center relative z-10 w-full max-w-[64rem] h-auto">
        ...
        />
        <button type="submit" className="absolute right-4 sm:absolute sm:ml-4 w-[1.5rem] h-[1.5rem]">
      ...
      <ul className="flex flex-col sm:flex-row gap-2 px-4 pt-4 pb-12 text-primary relative z-10 text-center">
        <li>
